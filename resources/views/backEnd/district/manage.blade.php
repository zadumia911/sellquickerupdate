          ...
          <div class="col-sm-12">
            <div class="manage-button">
              ...
              <div class="quick-button">
                <a href="{{url('editor/district/create')}}" class="btn btn-primary btn-actions btn-create">
                        ...
                        <tr>
                          ...
                          <td><ul class="action_buttons dropdown">
                              ...
                              <ul class="dropdown-menu">
                                <li>
                                  @if($value->status==1)
                                  <form action="{{url('editor/district/inactive')}}" method="POST">
                                    @csrf
                                    <input type="hidden" name="hidden_id" value="{{$value->id}}">
                                    <button type="submit" class="thumbs_up" title="unpublished"><i class="fa fa-thumbs-up"></i> Active</button>
                                  </form>
                                  @else
                                    <form action="{{url('editor/district/active')}}" method="POST">
                                      @csrf
                                      <input type="hidden" name="hidden_id" value="{{$value->id}}">
                                  ...
                                  <li>
                                      <a class="edit_icon" href="{{url('editor/district/edit/'.$value->id)}}" title="Edit"><i class="fa fa-edit"></i> Edit</a>
                                  </li>
                                </ul>
                              </ul>
                          </td>
