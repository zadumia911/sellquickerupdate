...
<!-- Mirrored from adminlte.io/themes/dev/AdminLTE/pages/examples/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 30 Jul 2019 10:47:35 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=utf-8" /><!-- /Added by HTTrack -->
<head>
  <meta charset="utf-8">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <title>Sellquicker::Login</title>
...
<div class="login-box">
  <div class="login-logo">
    <a href="{{url('/')}}" target="_blank"><b>Sellquicker Admin</b></a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
