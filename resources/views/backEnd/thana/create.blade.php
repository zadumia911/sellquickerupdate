            ...
            <div class="row">
              ...
              <div class="col-lg-8 col-md-8 col-sm-8">
                  <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form role="form" action="{{url('editor/thana/save')}}" method="POST" enctype="multipart/form-data">
                      @csrf
                      <div class="card-body">
                         <div class="form-group">
                              <label>Thana Name</label>
                              <input type="text" name="thana_name" class="form-control{{ $errors->has('thana_name') ? ' is-invalid' : '' }}" value="{{ old('thana_name') }}">
                        ...
                        <div class="form-group">
                              ...
                              <select name="dist_id" class="form-control select2 {{ $errors->has('dist_id') ? ' is-invalid' : '' }}" value="{{ old('dist_id') }}">
