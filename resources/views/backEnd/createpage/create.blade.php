...
@section('title','Create Create Page')
@section('content')
      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active"><a href="#">Create Page</a></li>
            ...
            <div class="row">
              ...
              <div class="col-lg-8 col-md-8 col-sm-8">
                  <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form role="form" action="{{url('editor/createpage/save')}}" method="POST" enctype="multipart/form-data">
                      @csrf
                      <div class="card-body">
