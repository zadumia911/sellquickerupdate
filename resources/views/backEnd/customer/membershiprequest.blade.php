...
@section('title','Requst Membership')
@section('content')
      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Requst Membership</li>
          </ol>
        </div>
      </div>
    </div>
                ...
                <div class="card">
                  <div class="card-body">
                    <table id="example1" class="table table-bordered table-striped">
                      ...
                      <tbody>
                       @foreach($membershiprequest as $key=>$value)
                        <tr>
                          ...
                          <td>
                            <ul class="action_buttons dropdown">
                              ...
                              <ul class="dropdown-menu">
                                  <li>
                                    <form action="{{url('superadmin/customer/membership-accept')}}" method="POST">
                                      @csrf
